...
; Imprime el marcador inicial del jugador 1
Marcador1:
	; Posicionar cursor
	mov [rowScreen], 3
	mov [colScreen], 50
	...
	; Imprimir por pantalla el número de pares
	mov ecx, [pairsPlayer1]
	add ecx, '0'
	mov [carac], cl
	sub ecx, '0'
	call printch

; Imprime el marcador inicial del jugador 2
Marcador2:
	; Posicionar cursor
	mov [rowScreen], 3
	mov [colScreen], 57
	...
	; Imprimir por pantalla el número de pares
	mov ecx, [pairsPlayer2]
	add ecx, '0'
	mov [carac], cl
	sub ecx, '0'
	call printch

; Bucle para abrir parejas
Continuar:
	; Salir de la función si se han abierto todas las parejas
	mov eax, [pairsPlayer1]
	add eax, [pairsPlayer2]
	cmp eax, 10
	je Final

	; Abrir una pareja de cartas
	call openPair
	cmp [tecla], 's'
	je Final
	cmp [HitPair], 1 ; Si HitPair es 0, se cambia de jugador
	jne ActualizarJugador

	; Qué jugador está jugando?
	cmp [Player], 1
	je Player1
	jmp Player2

; Cambiar a jugador 2, si ya estaba en el 2 salir de la función
ActualizarJugador:
	cmp [Player], 1
	jne Final
	mov eax, [Player]
...
; Incrementar el numero de parejas del jugador 1 y mostrarlas en el marcador
Player1:
	; Incrementa las parejas
	mov ebx, [pairsPlayer1]
	inc ebx
	mov [pairsPlayer1], ebx
...
; Incrementar el numero de parejas del jugador 2 y mostrarlas en el marcador
Player2:
	; Incrementa las parejas
	mov ebx, [pairsPlayer2]
	inc ebx
	mov [pairsPlayer2], ebx
...
Juga:
	; Comparar si ya se han abierto todas las parejas
	mov eax, [pairsPlayer1]
	add eax, [pairsPlayer2]
	cmp eax, 10
	je Resultado

	; Volver a hacer otra ronda del juego
	call open2Players
	cmp [Tecla], 's'
	je Resultado
	jmp Juga
